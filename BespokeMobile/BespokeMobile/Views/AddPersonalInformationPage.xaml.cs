...
namespace BespokeMobile.Views
{
    public partial class AddPersonalInformationPage : ContentPage
    {
        ...
        public AddPersonalInformationPage(CustomerReview customer)
        {
            ...
            //NxtBtn.ImageSource = ImageSource.FromResource("BespokeMobile.Assets.nextIcon.png", assembly);
            //BacKBtn.ImageSource = ImageSource.FromResource("BespokeMobile.Assets.backicon.png", assembly);
            //PhotoBtn.ImageSource = ImageSource.FromResource("BespokeMobile.Assets.cameraIcon.png", assembly);
