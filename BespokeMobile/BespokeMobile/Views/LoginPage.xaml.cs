using BespokeMobile.AuthHelpers;
using BespokeMobile.Popups;
using BespokeMobile.ViewModels;
...
namespace BespokeMobile.Views
{
    public partial class LoginPage : ContentPage
    {
        ...
        public LoginPage()
        {
            ...
            // logoImage.Source = ImageSource.FromResource("BespokeMobile.Assets.logo_high_resolution_white-1.png", assembly);
            //emailIcon.Source = ImageSource.FromResource("BespokeMobile.Assets.emailIcon.png", assembly);
            // passwordIcon.Source = ImageSource.FromResource("BespokeMobile.Assets.passwordIcon.png", assembly);
            //LoginButton.ImageSource= ImageSource.FromResource("BespokeMobile.Assets.LoginIcon.png", assembly);
