...
namespace NativeCamperVans.Droid
{
    [Activity(Label = "NativeCamperVans", Icon = "@mipmap/icon", Theme = "@style/MainTheme", MainLauncher = false, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
    public class MainActivity : global::Xamarin.Forms.Platform.Android.FormsAppCompatActivity
    {
        protected override void OnCreate(Bundle savedInstanceState)
        {
            TabLayoutResource = NativeCamperVans.Droid.Resource.Layout.Tabbar;
            ToolbarResource = NativeCamperVans.Droid.Resource.Layout.Toolbar;
