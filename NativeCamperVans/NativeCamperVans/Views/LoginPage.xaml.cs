using NativeCamperVans.AuthHelpers;
using NativeCamperVans.Popups;
using NativeCamperVans.ViewModels;
...
namespace NativeCamperVans.Views
{
    public partial class LoginPage : ContentPage
    {
        ...
        public LoginPage()
        {
            ...
            // logoImage.Source = ImageSource.FromResource("NativeCamperVans.Assets.logo_high_resolution_white-1.png", assembly);
            //emailIcon.Source = ImageSource.FromResource("NativeCamperVans.Assets.emailIcon.png", assembly);
            // passwordIcon.Source = ImageSource.FromResource("NativeCamperVans.Assets.passwordIcon.png", assembly);
            //LoginButton.ImageSource= ImageSource.FromResource("NativeCamperVans.Assets.LoginIcon.png", assembly);
